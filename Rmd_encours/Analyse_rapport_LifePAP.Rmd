...
lot: yes
lof: yes
subtitle: "Version de protocole : LifePAP"
lang: FR-fr
toc-title: Sommaire
---
...
#Si on ne sélectionne pas de protocole mettre NULL
...
* version protocole: 
  - Nombre d’observation : `r length(na.omit(enquetePecheLifePAP$'version protocole'))` 
  - Taux de remplissage : `r round((length(na.omit(enquetePecheLifePAP$'version protocole'))/length(enquetePecheLifePAP$'version protocole'))*100,2)`%
...
* type protocole:
  - Nombre d'observations :`r length(na.omit(enquetePecheLifePAP$'type protocole'))`
  - Taux de remplissage : `r round((length(na.omit(enquetePecheLifePAP$'type protocole'))/length(enquetePecheLifePAP$'version protocole'))*100,2)`%
  
```{r liste_protocoles}

versionProtocole.count <- enquetePecheLifePAP %>% count(`version protocole`)
...
typeProtocole.count <- enquetePecheLifePAP %>% count(`type protocole`)
...
* Nombre d’observations : `r length(na.omit(enquetePecheLifePAP$Accueil))`
* Taux de remplissage : `r round((length(na.omit(enquetePecheLifePAP$Accueil))/length(enquetePecheLifePAP$Accueil))*100,2)`%    
  
```{r accueil, fig.align='center', fig.asp=0.8, fig.cap="Différents types d'accueil"}

accueil.count <- enquetePecheLifePAP %>% count(Accueil)
...
* Nombre d’observations : `r length(na.omit(enquetePecheLifePAP$'Pecheur Sensibilisé'))`
* Taux de remplissage : `r round((length(na.omit(enquetePecheLifePAP$'Pecheur Sensibilisé'))/length(enquetePecheLifePAP$'Pecheur Sensibilisé'))*100,2)`%   

```{r pêcheurs sensibilisés, fig.cap="Part"}
...
* Sexe pêcheurs  
  + Nombre d’observations : `r length(na.omit(enquetePecheLifePAP$'Sexe - Pécheur'))`
  + Taux de remplissage : `r round((length(na.omit(enquetePecheLifePAP$'Sexe - Pécheur'))/length(enquetePecheLifePAP$'Sexe - Pécheur'))*100,2)`%  
* Sexe – autre membre  
  + Nombre d’observations : `r length(na.omit(enquetePecheLifePAP$'Sexe - Autre membre'))`
  + Taux de remplissage : `r round((length(na.omit(enquetePecheLifePAP$'Sexe - Autre membre'))/length(enquetePecheLifePAP$'Sexe - Autre membre'))*100,2)`%  
...
* Nombre d’observations : `r length(na.omit(enquetePecheLifePAP$'Constitution Groupe'))`
* Taux de remplissage : `r round((length(na.omit(enquetePecheLifePAP$'Constitution Groupe'))/length(enquetePecheLifePAP$'Constitution Groupe'))*100,2)`%   
...
* Nombre d’observations : `r length(na.omit(enquetePecheLifePAP$'CSP - Pécheur'))`
* Taux de remplissage : `r round((length(na.omit(enquetePecheLifePAP$'CSP - Pécheur'))/length(enquetePecheLifePAP$'CSP - Pécheur'))*100,2)`% 
...
* Année naissance – Pêcheur   
  + Nombre d’observations : `r length(na.omit(enquetePecheLifePAP$'Annee Naissance - Pécheur'))`
  + Taux de remplissage :  `r round((length(na.omit(enquetePecheLifePAP$'Annee Naissance - Pécheur'))/length(enquetePecheLifePAP$'Annee Naissance - Pécheur'))*100,2)`%
  + Moyenne : `r round(mean(enquetePecheLifePAP$'Annee Naissance - Pécheur', na.rm= TRUE),2)`
  + Minimum : `r min(enquetePecheLifePAP$'Annee Naissance - Pécheur', na.rm= TRUE)`
  + Maximum : `r max(enquetePecheLifePAP$'Annee Naissance - Pécheur', na.rm= TRUE)`
* Année naissance – Autre membre   
  + Nombre d’observations :  `r length(na.omit(enquetePecheLifePAP$'Annee Naissance - Autre membre'))`
  + Taux de remplissage : `r round((length(na.omit(enquetePecheLifePAP$'Annee Naissance - Autre membre'))/length(enquetePecheLifePAP$'Annee Naissance - Autre membre'))*100,2)`%
  + Moyenne : `r round(mean(enquetePecheLifePAP$'Annee Naissance - Autre membre', na.rm= TRUE),2)`
  + Minimum : `r min(enquetePecheLifePAP$'Annee Naissance - Autre membre', na.rm= TRUE)`
  + Maximum : `r max(enquetePecheLifePAP$'Annee Naissance - Autre membre', na.rm= TRUE)`
  



```{r age, fig.cap="Graphique représentant la diversité d'âge des pêcheurs"}
anneeNaissance <- tibble(annee=c(enquetePecheLifePAP$`Annee Naissance - Pécheur`,enquetePecheLifePAP$`Annee Naissance - Autre membre`),
                         sexe=c(enquetePecheLifePAP$'Sexe - Pécheur',enquetePecheLifePAP$'Sexe - Autre membre'))
...
* Commune résidence :  
  + Nombre d’observations : `r length(na.omit(enquetePecheLifePAP$'Commune résidence'))`
  + Taux de remplissage : `r round((length(na.omit(enquetePecheLifePAP$'Commune résidence'))/length(enquetePecheLifePAP$'Commune résidence'))*100,2)`%
* Départements   
  + Nombre d’observations : `r length(na.omit(enquetePecheLifePAP$Département))`
  + Taux de remplissage : `r round((length(na.omit(enquetePecheLifePAP$Département))/length(enquetePecheLifePAP$Département))*100,2)`%
* Pays  
  + Nombre d’observations : `r length(na.omit(enquetePecheLifePAP$Pays))`
  + Taux de remplissage : `r round((length(na.omit(enquetePecheLifePAP$Pays))/length(enquetePecheLifePAP$Pays))*100,2)`%



```{r départements, fig.cap="Tableau listant les différents départements d'origine des pêcheurs"}

departement.count <- enquetePecheLifePAP %>% count(`Département`)
departement.count<- drop_na(departement.count)
knitr::kable(departement.count, caption = "Liste des départements cités")
```
...
enquetePecheLifePAP.commune <- enquetePecheLifePAP %>% select(`Commune résidence`) %>% rename(commune=`Commune résidence`)

enquetePecheLifePAP.commune$commune <- str_replace_all(enquetePecheLifePAP.commune$commune, pattern="ST ", repl="SAINT ")
enquetePecheLifePAP.commune$commune <- str_replace_all(enquetePecheLifePAP.commune$commune, pattern="STE ", repl="SAINTE ")
enquetePecheLifePAP.commune$commune <- str_to_lower(enquetePecheLifePAP.commune$commune)
enquetePecheLifePAP.commune <- inner_join(enquetePecheLifePAP.commune,communeFrance,by="commune")

enquetePecheLifePAP.commune <- enquetePecheLifePAP.commune %>% filter(latitude>=41.15 & latitude<=51, longitude>=-7.8 & longitude <=10.62)




map <- get_map(c(-8,41,11,51),maptype = "roadmap")
ggmap(map,darken = .6,base_layer =ggplot(data = enquetePecheLifePAP.commune,aes(longitude,latitude)))+
...
+ Nombre d’observations : `r length(na.omit(enquetePecheLifePAP$Hebergement))`
+ Taux de remplissage : `r round((length(na.omit(enquetePecheLifePAP$Hebergement))/length(enquetePecheLifePAP$Hebergement))*100,2)`%

```{r hebergement, fig.cap="Graphique illustrant les différents types d'hébergements pour les pêcheurs non-résidents"}

hebergement.count <- enquetePecheLifePAP %>% count(Hebergement)
...
+ Nombre d’observations : `r length(na.omit(enquetePecheLifePAP$'Durée séjour'))`
+ Taux de remplissage : `r round((length(na.omit(enquetePecheLifePAP$'Durée séjour'))/length(enquetePecheLifePAP$'Durée séjour'))*100,2)`%
+ Moyenne : `r round(mean(enquetePecheLifePAP$'Durée séjour', na.rm=TRUE),2)`
+ Minimum : `r min(enquetePecheLifePAP$'Durée séjour', na.rm=TRUE)`
+ Maximum : `r max(enquetePecheLifePAP$'Durée séjour', na.rm=TRUE)`



```{r frequentation_littoral, fig.cap="Graphique de la durée de séjour sur le littoral"}

ggplot(enquetePecheLifePAP, aes(x = `Durée séjour`))+
  geom_histogram()+
  ylab("Nombre d'observation")+
  scale_x_continuous(breaks=seq(0,max(na.omit(enquetePecheLifePAP$`Durée séjour`)),20))+
  obade_theme
...
+ Nombre d’observations : `r length(na.omit(enquetePecheLifePAP$'Influence Destination'))`
+ Taux de remplissage : `r round((length(na.omit(enquetePecheLifePAP$'Influence Destination'))/length(enquetePecheLifePAP$'Influence Destination'))*100,2)`%
...
influence.count <- enquetePecheLifePAP %>% count(`Influence Destination`)
...
* Nombre d'observations :`r length(na.omit(enquetePecheLifePAP$'Premier Séjour'))`
* Taux de remplissage : `r round((length(na.omit(enquetePecheLifePAP$'Premier Séjour'))/length(enquetePecheLifePAP$'Premier Séjour'))*100,2)`%

```{r premier_séjour}

premiersejour.count <- enquetePecheLifePAP %>% count(`Premier Séjour`)
...
* Nombre d'observations : `r length(na.omit(enquetePecheLifePAP$'Influence Date'))`
* Taux de remplissage : `r round((length(na.omit(enquetePecheLifePAP$'Influence Date'))/length(enquetePecheLifePAP$'Influence Date'))*100,2)`%

```{r influence_date}

infludate.count <- enquetePecheLifePAP %>% count(`Influence Date`)
...
* Nombre d’observations : `r length(na.omit(enquetePecheLifePAP$'Milieu(x)'))`
* Taux de remplissage : `r round((length(na.omit(enquetePecheLifePAP$'Milieu(x)'))/length(enquetePecheLifePAP$'Milieu(x)'))*100,2)`%
...
milieux.count <- enquetePecheLifePAP %>% separate_rows(`Milieu(x)`,sep="\\|") 
...
* Espéces  
  + Nombre d’observations : `r length(na.omit(enquetePecheLifePAP$Espéces))`
  + Taux de remplissage : `r round((length(na.omit(enquetePecheLifePAP$Espéces))/length(enquetePecheLifePAP$Espéces))*100,2)`%
  + Commentaires : plusieurs modalités dans une observation. Elles sont séparées par |.
* Outils ou technique  
  + Nombre d’observations : `r length(na.omit(enquetePecheLifePAP$'Outils ou techniques'))`
  + Taux de remplissage : `r round((length(na.omit(enquetePecheLifePAP$'Outils ou techniques'))/length(enquetePecheLifePAP$'Outils ou techniques'))*100,2)`%
  + Commentaires : plusieurs modalités dans une observation. Elles sont séparées par |.  
...
espece.count<- enquetePecheLifePAP %>% separate_rows('Espéces',sep="\\|") 
...
outilut.count<- enquetePecheLifePAP %>% separate_rows('Outils ou techniques',sep="\\|") 
...
* Nombre d’observations : `r length(na.omit(enquetePecheLifePAP$'Annee Premiere Peche'))`
* Taux de remplissage : `r round((length(na.omit(enquetePecheLifePAP$'Annee Premiere Peche'))/length(enquetePecheLifePAP$'Annee Premiere Peche'))*100,2)`%
* Moyenne : `r round(mean(enquetePecheLifePAP$'Annee Premiere Peche', na.rm= TRUE),2)`
* Minimum : `r min(enquetePecheLifePAP$'Annee Premiere Peche', na.rm=TRUE)` 
* Maximum : `r max(enquetePecheLifePAP$'Annee Premiere Peche', na.rm=TRUE)`

```{r experience_peche, fig.cap="Nombre de pêcheur par année d'expérience"}
exppeche.count <- enquetePecheLifePAP %>% count(`Annee Premiere Peche`)
...
* Nombre d’observations : `r length(na.omit(enquetePecheLifePAP$'Motivation(s)'))`
* Taux de remplissage : `r round((length(na.omit(enquetePecheLifePAP$'Motivation(s)'))/length(enquetePecheLifePAP$'Motivation(s)'))*100,2)`%
* Commentaires : plusieurs modalités dans une observation. Elles sont séparées par |.  

```{r motivations_pecheur, fig.cap="Nombre de pêcheurs par motivations invoquées pour la pratique de pêche à pied"}

motiv.count<- enquetePecheLifePAP %>% separate_rows('Motivation(s)',sep="\\|") 
...
* Nombre d’observations : `r length(na.omit(enquetePecheLifePAP$'Autres types de peche'))`
* Taux de remplissage :`r round((length(na.omit(enquetePecheLifePAP$'Autres types de peche'))/length(enquetePecheLifePAP$'Autres types de peche'))*100,2)`%

```{r autre_peche, fig.cap="Nombre de pêcheurs pratiquant une autre pratique de pêche"}
autrepeche.count <- enquetePecheLifePAP %>% separate_rows(`Autres types de peche`,sep="\\|") 
...
* Départements  
  + Nombre d’observations : `r length(na.omit(enquetePecheLifePAP$Départements))`
  + Taux de remplissage : `r round((length(na.omit(enquetePecheLifePAP$Départements))/length(enquetePecheLifePAP$Départements))*100,2)`%
  + Commentaires : plusieurs modalités dans une observation. Elles sont séparées par |.
* Autres sites fréquentés   
  + Nombre d’observations : `r length(na.omit(enquetePecheLifePAP$'Autre Sites fréquentés'))`
  + Taux de remplissage : `r round((length(na.omit(enquetePecheLifePAP$'Autre Sites fréquentés'))/length(enquetePecheLifePAP$'Autre Sites fréquentés'))*100,2)`%
* Noms sites :  
  + Nombre d’observations : `r length(na.omit(enquetePecheLifePAP$'Nom sites'))`
  + Taux de remplissage : `r round((length(na.omit(enquetePecheLifePAP$'Nom sites'))/length(enquetePecheLifePAP$'Nom sites'))*100,2)`%
...
autres_sites.count <- enquetePecheLifePAP %>% count(`Nom sites`)
knitr::kable(autres_sites.count, caption = "Nom de sites d'autres sités fréquentés")
```
  
```{r departements}
depart.count <- enquetePecheLifePAP %>% separate_rows(`Départements`,sep="\\|") 
...
* Coefficient Maree Mini  
  + Nombre d’observations : `r length(na.omit(enquetePecheLifePAP$'Coefficient Maree Mini'))`
  + Taux de remplissage : `r round((length(na.omit(enquetePecheLifePAP$'Coefficient Maree Mini'))/length(enquetePecheLifePAP$'Coefficient Maree Mini'))*100,2)`%
  + Moyenne : `r round(mean(enquetePecheLifePAP$'Coefficient Maree Mini', na.rm=TRUE),2)`
  + Minimum : `r min(enquetePecheLifePAP$'Coefficient Maree Mini', na.rm=TRUE)`
  + Maximum : `r max(enquetePecheLifePAP$'Coefficient Maree Mini', na.rm=TRUE)`
* Choix des marées   
  + Nombre d’observations : `r length(na.omit(enquetePecheLifePAP$'Choix des marées'))`
  + Taux de remplissage : `r round((length(na.omit(enquetePecheLifePAP$'Choix des marées'))/length(enquetePecheLifePAP$'Choix des marées'))*100,2)`% 
  + Commentaires : plusieurs modalités dans une observation. Elles sont séparées par "|".  

```{r criteres_choix_marée, fig.cap="Nombre de pêcheurs selon le coefficient minimum pour aller pêcher"}

coefmini.count <- enquetePecheLifePAP %>% count(`Coefficient Maree Mini`) %>% rename( coefminimum = `Coefficient Maree Mini`)
...
choixmarees.count <- enquetePecheLifePAP %>% separate_rows(`Choix des marées`, sep = '\\|')
...
* Nombre d’observations : `r length(na.omit(enquetePecheLifePAP$'Critéres choix site'))`
* Taux de remplissage : `r round((length(na.omit(enquetePecheLifePAP$'Critéres choix site'))/length(enquetePecheLifePAP$'Critéres choix site'))*100,2)`%
* Commentaires : plusieurs modalités dans une observation. Elles sont séparées par |.  

```{r critères_choix_site}

critchoixsite.count <-enquetePecheLifePAP %>% separate_rows(`Critéres choix site`, sep = '\\|')
...
* Frequence de la pratique de la pêche
  - Nombre d’observations : `r length(na.omit(enquetePecheLifePAP$'Frequence Declaree Peche'))`
  - Taux de remplissage : `r round((length(na.omit(enquetePecheLifePAP$'Frequence Declaree Peche'))/length(enquetePecheLifePAP$'Frequence Declaree Peche'))*100,2)`%
  - Moyenne : `r round(mean(enquetePecheLifePAP$'Frequence Declaree Peche', na.rm=TRUE),2)`
  - Minimum : `r min(enquetePecheLifePAP$'Frequence Declaree Peche', na.rm=TRUE)`
  - Maximum : `r max(enquetePecheLifePAP$'Frequence Declaree Peche', na.rm=TRUE)`
* Peche chaque annee
  - Nombre d'observations : `r length(na.omit(enquetePecheLifePAP$'Peche Chaque Annee'))`
  - Taux de remplissage : `r round((length(na.omit(enquetePecheLifePAP$'Peche Chaque Annee'))/length(enquetePecheLifePAP$'Peche Chaque Annee'))*100,2)`%
* Premiere pêche
  - Nombre d'observations : `r length(na.omit(enquetePecheLifePAP$'Premiere Peche'))`
  - Taux de remplissage : `r round((length(na.omit(enquetePecheLifePAP$'Premiere Peche'))/length(enquetePecheLifePAP$'Premiere Peche'))*100,2)`%
* Nombre pêche an
  - Nombre d'observations : `r length(na.omit(enquetePecheLifePAP$'Nb Peches Annuelles'))`
  - Taux de remplissage : `r round((length(na.omit(enquetePecheLifePAP$'Nb Peches Annuelles'))/length(enquetePecheLifePAP$'Nb Peches Annuelles'))*100,2)`%
  - Moyenne : `r round(mean(enquetePecheLifePAP$'Nb Peches Annuelles', na.rm=TRUE),2)`
  - Minimum : `r min(enquetePecheLifePAP$'Nb Peches Annuelles', na.rm=TRUE)`
  - Maximum : `r max(enquetePecheLifePAP$'Nb Peches Annuelles', na.rm=TRUE)`
  

```{r frequence_pratique, fig.cap="Fréquence de la pratique de la pêche"}

freqprat.count <- enquetePecheLifePAP %>% count(`Frequence Declaree Peche`)
...
pecheannee.count <- enquetePecheLifePAP %>% count(`Peche Chaque Annee`)
...
premierepeche.count <- enquetePecheLifePAP %>% count(`Premiere Peche`)
...
ggplot(enquetePecheLifePAP, aes(x = `Nb Peches Annuelles`))+
  geom_histogram(breaks=seq(0,max(na.omit(enquetePecheLifePAP$`Nb Peches Annuelles`)),5))+  
  scale_x_continuous(breaks=seq(0,max(na.omit(enquetePecheLifePAP$`Nb Peches Annuelles`)),20))+
...
* Nombre d’observations : `r length(na.omit(enquetePecheLifePAP$'Mois de peche'))`
* Taux de remplissage : `r round((length(na.omit(enquetePecheLifePAP$'Mois de peche'))/length(enquetePecheLifePAP$'Mois de peche'))*100,2)`% 
* Commentaires : plusieurs modalités dans une observation. Elles sont séparées par |.  
  
```{r periode_frequentation, fig.cap="Période de fréquentation du site"}

freqperiode.count <- enquetePecheLifePAP %>% separate_rows(`Mois de peche`, sep = '\\|')
...
* Annuaire de marée 
* Nombre d’observations : `r length(na.omit(enquetePecheLifePAP$"Annuaire de marée"))` 
* Taux de remplissage : `r round((length(na.omit(enquetePecheLifePAP$"Annuaire de marée"))/length(enquetePecheLifePAP$"Annuaire de marée"))*100,2)`%
* Commentaires : plusieurs modalités dans une observation. Elles sont séparées par |.  
  
```{r annuaire_maree}

annuairemaree.count <- enquetePecheLifePAP %>% count(`Annuaire de marée`)
...
sourceinfomaree.count <- enquetePecheLifePAP %>% separate_rows(`Source d'information`, sep = '\\|')
...
* Etat Sanitaire :  
  + Nombre d’observations : `r length(na.omit(enquetePecheLifePAP$'Etat Sanitaire'))`
  + Taux de remplissage : `r round((length(na.omit(enquetePecheLifePAP$'Etat Sanitaire'))/length(enquetePecheLifePAP$'Etat Sanitaire'))*100,2)`% 
* Source d’information  
  + Nombre d’observations : `r length(na.omit(enquetePecheLifePAP$"Source d'information"))`
  + Taux de remplissage : `r round((length(na.omit(enquetePecheLifePAP$"Source d'information"))/length(enquetePecheLifePAP$"Source d'information"))*100,2)`% 
  + Commentaires : plusieurs modalités dans une observation. Elles sont séparées par |.  
  
```{r etat_sanitaire, fig.cap="Graphique illustrant la connaissance ou non de l'état sanitaire"}

etatsanit.count <- enquetePecheLifePAP %>% count(`Etat Sanitaire`)
...
infosanit.count <- enquetePecheLifePAP %>% separate_rows(`Source d'information`, sep= '\\|')
...
* Connaissance réglementation  
  + Nombre d’observations : `r length(na.omit(enquetePecheLifePAP$'connaissance réglementation'))`
  + Taux de remplissage :  `r round((length(na.omit(enquetePecheLifePAP$'connaissance réglementation'))/length(enquetePecheLifePAP$'connaissance réglementation'))*100,2)`%
* Connaissance quotas
  + Nombre d’observations : `r length(na.omit(enquetePecheLifePAP$'Connaissance quota'))`
  + Taux de remplissage :  `r round((length(na.omit(enquetePecheLifePAP$'Connaissance quota'))/length(enquetePecheLifePAP$'Connaissance quota'))*100,2)`%
* Connaissance période
  + Nombre d’observations : `r length(na.omit(enquetePecheLifePAP$'Connaissance Période'))`
  + Taux de remplissage : `r round((length(na.omit(enquetePecheLifePAP$'Connaissance Période'))/length(enquetePecheLifePAP$'Connaissance Période'))*100,2)`%
* Source d’information
  + Nombre d’observations : `r length(na.omit(enquetePecheLifePAP$'Source information législation'))`
  + Taux de remplissage :`r round((length(na.omit(enquetePecheLifePAP$'Source information législation'))/length(enquetePecheLifePAP$'Source information législation'))*100,2)`%
  + Commentaires : plusieurs modalités dans une observation. Elles sont séparées par |.
* Informé Législation
  + Nombre d’observations : `r length(na.omit(enquetePecheLifePAP$'Informé Législation'))`
  + Taux de remplissage : `r round((length(na.omit(enquetePecheLifePAP$'Informé Législation'))/length(enquetePecheLifePAP$'Informé Législation'))*100,2)`%
* Périodes déclarées
  + Nombre d’observations : `r length(na.omit(enquetePecheLifePAP$'Périodes Déclarées'))`
  + Taux de remplissage : `r round((length(na.omit(enquetePecheLifePAP$'Périodes Déclarées'))/length(enquetePecheLifePAP$'Périodes Déclarées'))*100,2)`%
* Connaissance réglementation période
  + Nombre d’observations : `r length(na.omit(enquetePecheLifePAP$'Connaissance Règlementation Période'))`
  + Taux de remplissage :  `r round((length(na.omit(enquetePecheLifePAP$'Connaissance Règlementation Période'))/length(enquetePecheLifePAP$'Connaissance Règlementation Période'))*100,2)`%
...
connregl.count <- enquetePecheLifePAP %>% count(`connaissance réglementation`)
...
connquotas.count <- enquetePecheLifePAP %>% count(`Connaissance quota`)
...
connperiode.count <- enquetePecheLifePAP %>% count(`Connaissance Période`)
...
infolegis.count <- enquetePecheLifePAP %>% separate_rows(`Source information législation`, sep= '\\|')
...
inflegis.count <- enquetePecheLifePAP %>% count(`Informé Législation`)
...
connperregl.count <- enquetePecheLifePAP %>% count(`Connaissance Règlementation Période`)
...
* Membre association :
  + Nombre d’observations : `r length(na.omit(enquetePecheLifePAP$"Membre Association"))`
  + Taux de remplissage : `r round((length(na.omit(enquetePecheLifePAP$'Membre Association'))/length(enquetePecheLifePAP$'Membre Association'))*100,2)`%
* Nom Association :
  + Nombre d'observations : `r length(na.omit(enquetePecheLifePAP$"Nom Association"))`
  + Taux de remplissage : `r round((length(na.omit(enquetePecheLifePAP$"Nom Association"))/length(enquetePecheLifePAP$"Nom Association"))*100,2)`%
  
```{r association, fig.align= 'center', fig.cap="Nombre de pêcheurs adhérent à une association"}

assoc.count <- enquetePecheLifePAP %>% count(`Membre Association`)
...
nomassoc.count <- enquetePecheLifePAP %>% count(`Nom Association`)
...
* Nombre d’observations : `r length(na.omit(enquetePecheLifePAP$'Conseils consommation'))`
* Taux de remplissage : `r round((length(na.omit(enquetePecheLifePAP$'Conseils consommation'))/length(enquetePecheLifePAP$'Conseils consommation'))*100,2)`%

  
```{r degorgement, eval=FALSE, include=FALSE}


degor.count <- enquetePecheLifePAP %>% count(`Conseils consommation`)
...
* Utilisation outil  
  + Nombre d’observations :`r length(na.omit(enquetePecheLifePAP$'Utilisation outil'))`
  + Taux de remplissage : `r round((length(na.omit(enquetePecheLifePAP$'Utilisation outil'))/length(enquetePecheLifePAP$'Utilisation outil'))*100,2)`%
* Source outil  
  + Nombre d’observations : `r length(na.omit(enquetePecheLifePAP$'Source outil'))`
  + Taux de remplissage : `r round((length(na.omit(enquetePecheLifePAP$'Source outil'))/length(enquetePecheLifePAP$'Source outil'))*100,2)`%
* Outil conforme
  - Nombre d'observations :`r length(na.omit(enquetePecheLifePAP$'Outil Conforme'))`
  - Taux de remplissage : `r round((length(na.omit(enquetePecheLifePAP$'Outil Conforme'))/length(enquetePecheLifePAP$'Outil Conforme'))*100,2)`%
  
```{r outil_mesure, fig.cap="Nombre de pêcheur utilisant un outil de mesure"}

outil.count <- enquetePecheLifePAP %>% count(`Utilisation outil`)
...
sourceoutil.count <- enquetePecheLifePAP %>% count(`Source outil`) %>%  mutate(`Source outil`=iconv(`Source outil`,"UTF-8",to="latin1", sub="byte"))
...
outilconf.count <- enquetePecheLifePAP %>% count(`Outil Conforme`)
...
* Espèce  
  + Nombre d’observations : `r length(na.omit(enquetePecheLifePAP$'Espece'))`
  + Taux de remplissage : `r round((length(na.omit(enquetePecheLifePAP$'Espece'))/length(enquetePecheLifePAP$'Espece'))*100,2)`%
* Nb individus
  + Nombre d’observations : `r length(na.omit(enquetePecheLifePAP$'Nb individus'))`
  + Taux de remplissage : `r round((length(na.omit(enquetePecheLifePAP$'Nb individus'))/length(enquetePecheLifePAP$'Nb individus'))*100,2)`%
  + Moyenne : `r round(mean(enquetePecheLifePAP$'Nb individus', na.rm=TRUE),2)`
  + Minimum : `r min(enquetePecheLifePAP$'Nb individus', na.rm=TRUE)`
  + Maximum : `r max(enquetePecheLifePAP$'Nb individus', na.rm=TRUE)`
* Poids récolte
  + Nombre d’observations : `r length(na.omit(enquetePecheLifePAP$'Poids récolte'))`
  + Taux de remplissage : `r round((length(na.omit(enquetePecheLifePAP$'Poids récolte'))/length(enquetePecheLifePAP$'Poids récolte'))*100,2)`%
  + Moyenne : `r round(mean(enquetePecheLifePAP$'Poids récolte', na.rm=TRUE),2)`
  + Minimun : `r min(enquetePecheLifePAP$'Poids récolte', na.rm=TRUE)`
  + Maximun : `r max(enquetePecheLifePAP$'Poids récolte', na.rm=TRUE)`
  + Commentaires : Données anormales soit trop importantes, soit petites
* Panier vide
  + Nombre d’observations : `r length(na.omit(enquetePecheLifePAP$'Panier vide'))`
  + Taux d’observations : `r round((length(na.omit(enquetePecheLifePAP$'Panier vide'))/length(enquetePecheLifePAP$'Panier vide'))*100,2)`%

```{r espece_panier, fig.cap="Liste des espèces pêchées par les pêcheurs"}

especepanier.count <- enquetePecheLifePAP %>% count(`Espece`)
...
individu.count <- enquetePecheLifePAP %>% count(`Nb individus`)
...
poidsrecolte.count <- enquetePecheLifePAP %>% count(`Poids récolte`)
...
paniervide.count <- enquetePecheLifePAP %>% count(`Panier vide`)
...
* Conformité maille   
  + Nombre d’observations : `r length(na.omit(enquetePecheLifePAP$'Conformité maille'))`
  + Taux de remplissage : `r round((length(na.omit(enquetePecheLifePAP$'Conformité maille'))/length(enquetePecheLifePAP$'Conformité maille'))*100,2)`%
* Conformité quantité
  + Nombre d’observations : `r length(na.omit(enquetePecheLifePAP$'Conformité quantité'))`
  + Taux de remplissage : `r round((length(na.omit(enquetePecheLifePAP$'Conformité quantité'))/length(enquetePecheLifePAP$'Conformité quantité'))*100,2)`%

```{r conformite_maille, fig.cap="Nombre de pêcheurs ayant un panier conforme pour la maille"}

confomaille.count <- enquetePecheLifePAP %>% count(`Conformité maille`)
...
confoquant.count <- enquetePecheLifePAP %>% count(`Conformité quantité`)
...
* Nombre d’observations : `r length(na.omit(enquetePecheLifePAP$'Temps total Peche'))`
* Taux de remplissage : `r round((length(na.omit(enquetePecheLifePAP$'Temps total Peche'))/length(enquetePecheLifePAP$'Temps total Peche'))*100,2)`%
* Moyenne : `r round(mean(enquetePecheLifePAP$'Temps total Peche', na.rm=TRUE), 2)`
* Minimum : `r min(enquetePecheLifePAP$'Temps total Peche', na.rm=TRUE)`
* Maximum : `r max(enquetePecheLifePAP$'Temps total Peche', na.rm=TRUE)`


```{r temps_peche, fig.cap="Temps de pêche moyen"}

ggplot(enquetePecheLifePAP, aes(x = `Temps total Peche`))+
  geom_histogram(breaks=seq(0,max(na.omit(enquetePecheLifePAP$`Temps total Peche`)),20))+  
  scale_x_continuous(breaks=seq(0,max(na.omit(enquetePecheLifePAP$`Temps total Peche`)),40))+
...
``` {r periode_privilégées, fig.height=16,fig.width=5}

periodepriv.count <- enquetePecheLifePAP %>% separate_rows(`Choix des marées`, sep = '\\|')
...
* Nombre d’observations : `r length(na.omit(enquetePecheLifePAP$'Sensibilisation'))`
* Taux de remplissage : `r round((length(na.omit(enquetePecheLifePAP$'Sensibilisation'))/length(enquetePecheLifePAP$'Sensibilisation'))*100,2)`%
   
```{r reception_conseils, fig.cap="Reception des pêcheurs face aux conseils promulgués"}

recpcons.count <- enquetePecheLifePAP %>% count(`Sensibilisation`)
...
* Nombre d’observations : `r length(na.omit(enquetePecheLifePAP$'Tri du panier'))`
* Taux de remplissage : `r round((length(na.omit(enquetePecheLifePAP$'Tri du panier'))/length(enquetePecheLifePAP$'Tri du panier'))*100,2)`%

```{r tri_recolte, fig.cap="Tri des récoltes"}

trirecolte.count <- enquetePecheLifePAP %>% count(`Tri du panier`)
...
* Nb Reglettes
  - Nombre d'observations : `r length(na.omit(enquetePecheLifePAP$'Nb Reglettes'))`
  - Taux de remplissage : `r round((length(na.omit(enquetePecheLifePAP$'Nb Reglettes'))/length(enquetePecheLifePAP$'Nb Reglettes'))*100,2)`%
  - Moyenne : `r round(mean(enquetePecheLifePAP$'Nb Reglettes', na.rm = TRUE), 2)`
  - Minimum : `r min(enquetePecheLifePAP$'Nb Reglettes', na.rm=TRUE)`
  - Maximum : `r max(enquetePecheLifePAP$'Nb Reglettes', na.rm=TRUE)`
* Nb Depliants
  - Nombre d'observations :`r length(na.omit(enquetePecheLifePAP$'Nb Depliants'))`
  - taux de remplissage :  `r round((length(na.omit(enquetePecheLifePAP$'Nb Depliants'))/length(enquetePecheLifePAP$'Nb Depliants'))*100,2)`%
  - Moyenne : `r round(mean(enquetePecheLifePAP$'Nb Depliants', na.rm = TRUE), 2)`
  - Minimum : `r min(enquetePecheLifePAP$'Nb Depliants', na.rm=TRUE)`
  - Maximum : `r max(enquetePecheLifePAP$'Nb Depliants', na.rm=TRUE)`
  
```{r reglettes}

reglette.count <- enquetePecheLifePAP %>% count(`Nb Reglettes`)
reglette.count <- drop_na(reglette.count)

ggplot(enquetePecheLifePAP, aes(x = `Nb Reglettes`))+
  geom_histogram()+
  ylab("Nombre d'observations")+
  obade_theme
```
...
ggplot(enquetePecheLifePAP, aes(x = `Nb Depliants`))+
  geom_histogram()+
  ylab("Nombre d'observations")+
  obade_theme
...
commune.count <- enquetePecheLifePAP %>% count(`Commune résidence`)
...
noms_sites.count <- enquetePecheLifePAP %>% count(`Nom sites`) %>% mutate(`Nom sites` =iconv(`Nom sites`,"UTF-8",to="latin1", sub="byte"))
