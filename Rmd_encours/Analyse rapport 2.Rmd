...
selection_territoire <- "Côtes d'Armor"

ifelse(selection_territoire != "",
       enquetePecheSel <- enquetePeche %>% filter(territoire==selection_territoire),
