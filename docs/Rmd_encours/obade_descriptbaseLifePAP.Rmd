...
enquetePecheLifePAP.resum <- enquetePecheLifePAP.resum %>% mutate(pourc_NA=(Nombre_NA/nrow(enquetePecheLifePAP))*100)
knitr::kable(enquetePecheLifePAP.resum %>% select(-pourc_NA))
```

```{r pratPeche.na, echo=FALSE, fig.height=7, fig.width=13}
