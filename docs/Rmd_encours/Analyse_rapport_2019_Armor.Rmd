...
lot: yes
lof: yes
subtitle: "territoires des côtes d'Armor"
lang: FR-fr
toc-title: Sommaire
---
...
require(ggplot2)
require(ggmap)
#register_google(key = "AIzaSyA4RfyP4pAjJoQJWNumnJB7avM98mHfkf0", write = TRUE)
require(tidyverse)
require(tinytex)
require(ggmap)
```
...
selection_annee <- enquetePeche %>% 
      filter(`date sortie`>= "2019-01-01" ,`date sortie`<= "2019-12-31")

selection_territoire <- c("Côtes-d'Armor", "Côtes d'Armor", "Côtes d'Armor. Ile et Vilaine", "Binic", "Binic. 29 (Riec-Sur-Belon)", "Binic. Etable sur mer. 56 (Larmor-Plage)", "Plérin") 


ifelse(length(selection_annee) > 0,
