...
### **Points importants :**
 ...
 - Au total `r as.numeric(enquetePeche.resum[3,3])` observateurs[^1] répartis selon les `r as.numeric(enquetePeche.resum[38,3])` territoires. Grande hétérogénéité dans la dénomination des observateurs qui peut poser un problème dans certains cas pour retrouver le ou les observateur(s).
