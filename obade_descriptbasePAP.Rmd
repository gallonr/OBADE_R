...
Les données ont été extraites le `r format(Sys.Date(), "%d-%m-%Y")` via le site web (https://estamp.afbiodiversite.fr/). L'extraction est composer de  `r length(list.files("./data/enquete/"))` fichiers :
